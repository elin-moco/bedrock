...
sitemaps = {
    ...
    'firefox_details': ViewsSitemap(
        ['firefox.customize', 'firefox.performance', 'firefox.technology', 'firefox.security',
         'firefox.mobile.faq', 'firefox.partners.index', 'firefox.os.faq',
    ...
    'about': ViewsSitemap(
        ['mozorg.products', 'mozorg.about', 'mozorg.about.manifesto', 'mocotw.about.space',
         'mocotw.about.careers', 'mocotw.about.contact'],
        0.6, 'monthly'),
    ...
    'misc': ViewsSitemap(
        ['mocotw.news', 'mocotw.sumo', 'newsletter.index', 'lightbeam.lightbeam', 'lightbeam.about', 'mocotw.eoy2013',
         'mocotw.2013review', 'mocotw.shop-with-firefox', 'firefox.speed',
